...
import htmlTemplate from '/home/gijs/projects/vue-suspense-bug/.nuxt/views/document.template.mjs';
import { renderToString as renderToString$2 } from 'vue/server-renderer';

const _runtimeConfig = {public:{VITE_STORYBLOK_TOKEN:void 0,app:{basePath:"\u002F",assetsPath:"\u002F_nuxt\u002F",cdnURL:null}},private:{}};
...
const STATIC_ASSETS_BASE = "/home/gijs/projects/vue-suspense-bug/dist" + "/" + "1643755260";
const PAYLOAD_JS = "/payload.js";
const getClientManifest = cachedImport(() => import('/home/gijs/projects/vue-suspense-bug/.nuxt/dist/server/client.manifest.mjs'));
const getSSRApp = cachedImport(() => import('/home/gijs/projects/vue-suspense-bug/.nuxt/dist/server/server.mjs'));
